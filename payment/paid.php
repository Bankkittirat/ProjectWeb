...
<html>
    ...
    <title>CSGAMESTORE &mdash; Paid</title>
    ...
    opacity:0.6;
        ...
        <br /><br /> 
           <div class="container" style="width:500px;">  
                <h3 align="center" class="gg">Thank you</h3>  
                <br><br/>
                <form method="post" enctype="multipart/form-data">  
                <div align="center" >
                     <span class="TIII">Your receipt has been uploaded.<br> Please wait for the administrator to verify. <br>And we will send the key to you by email.</span>
                     <br/><br/><br/><br/><br/>
                </div>
                <div align="center" >
