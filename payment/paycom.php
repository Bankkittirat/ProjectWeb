...
{  
      ...
      $query = "INSERT INTO tbl_images(name,username,Email) VALUES ('$file','$username','$mail1')";  
      ...
      {    
           ...
           $io = $io+1;} 
            if($io==1){
                Header("Location: ../mailjet/sendme.php");
            }
      }  
}  
$ios = 0;                     
...
<html>
    ...
    <title>CSGAMESTORE &mdash; Confirm</title>
		...
		<nav class="gtco-nav" role="navigation">
			<div class="gtco-container">
				...
				<div class="row">
                    ...
                    <div id="gtco-logo"><a class="ez" onClick='alert("กรุณาอัพโหลดใบเสร็จก่อน เราไม่ให้ออก ออกแล้วจะเอาไรกิน")'>CSGAMESTORE</div>
					</div>
    ...
    color: white;}
        ...
        <br /><br /> 
           <div class="container" style="width:500px;">  
                <h3 align="center">PAYMENT COMFIRM</h3>  
                <br><br/><br/>
                <form method="post" enctype="multipart/form-data">  
                <div class="slip" >
                     <input type="file" name="image" id="image"> 
                     <span class="TIII">*สลิปการโอนเงิน</span>
                     <br/><br/><br/>
                </div>
                <div align="center" >
					<button type="submit" action="upload_file.php" name="insert" id="insert" class="button6 sizeb">Upload your receipt</button>
				</div>
                </form><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>

                <div align="center" >
                    <!-- <a href = "pay.php" type="submit" name="back1" id="back12" class="button5 sizeb">Back to pay</a> -->
                    <form method='post'>
                    <button type="submit" name="back1" id="back1" class="button4 sizeb">Back to pay</button>
                    </form>
           ...
           <style>
                .sizeba{height:50px;width:200px;}
                .sizeb{height:50px;width:200px;}
                .button4 {
                    background-color: white;
                    color: black;
