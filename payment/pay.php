	...
	<div id="page" >
			...
			<div class="gtco-container">
				...
				<div class="row">
					<div class="col-sm-2 col-xs-12">
						<div id="gtco-logo"><a class="ez" onClick='alert("กรุณาชำระเงินก่อน เราไม่ให้ออก ออกแล้วจะเอาไรกิน")'>CSGAMESTORE</div>
					</div>
        ...
        <br><br>  
           ...
           <div class="container " style="width:500px;">  
                ...
                <?php echo "Your Game : ".$YourG." --> Price : ".$Price." Baht"; 
                ?> <br><br>
                <form action="couponC.php" method="post">
                กรอกคูปองลดราคาที่นี้ : <input type="text" name="coupon"><?php $CPW?><br>
                <br>
                <input type="submit">
                </form>
                <?php 
