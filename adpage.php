...
<div class="bgbg">
	...
	<div id="page" >
		...
		<style>
          ...
          tr.gg td{
               background-color: white;opacity:0.95;text-align:center;

          }
          tr.gg th{
               background-color: white;opacity:0.8;text-align:center;
        ...
        <br /><br />  
           <div class="container" style="width:500px;">  
               ...
               <div class="gg">
                ...
                ON tbl_images.id = gorder.id ORDER BY order_time DESC";   
               ...
               { 
                    echo '  
                         ...
                         ';   
                                   ...
                                   echo "<input type='hidden' name='id' value='$OT4'>";
                                   ...
                                   echo "<input type='submit' value='ข้อมูลไม่ถูกต้อง' name='L_$RTY'>";
                                   echo "</form></td><td>";
