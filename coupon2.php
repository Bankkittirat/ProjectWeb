    ...
    font-size:30px;
        ...
        <br /><br /> 
           <div class="container" style="width:1500px;">  
                <h3 align="center" class="gg">Developers are generous. Give away free code here.</h3>  
                <br><br/><br><br/>
                <form method="post" enctype="multipart/form-data">  
                <div align="center" >
                    <span class="TIII">Because we are handsome and our kindness We therefore give out 10% discount code to you.</span><br/><br/>
                    <span class="TIIII">Here is your code : </span><span class="TIIIII">ASDFGH</span>
