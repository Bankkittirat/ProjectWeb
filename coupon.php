    ...
    font-size:30px;
        ...
        <br /><br /> 
           <div class="container" style="width:1500px;">  
                <h3 align="center" class="gg">Free discount codes welcome the upcoming summer.</h3>  
                <br><br/><br><br/>
                <form method="post" enctype="multipart/form-data">  
                <div align="center" >
                    <span class="TIII">For this summer. We have some little gift for you all. 5% discount </span><br/><br/>
                    <span class="TIIII">Here is your code : </span><span class="TIIIII">QWERTY</span>
